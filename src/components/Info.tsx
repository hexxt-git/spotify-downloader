  ...
  const content = (
    <div className="space-y-6 text-left">
      <div className="space-y-4">
        ...
        <div>
          This website is a Spotify playlist downloader that helps you convert your favorite Spotify playlists into downloadable MP3 files. Here's how it works:
        </div>
        
        <div className="space-y-2">
          <h4 className="font-bold">1. Playlist Input</h4>
          <div>Simply paste a Spotify playlist link into the input field. The link should look something like: https://open.spotify.com/playlist/...</div>
        </div>

        <div className="space-y-2">
          <h4 className="font-bold">2. Track Loading</h4>
          <div>The system will load all tracks from your playlist, showing you the title, artist, and duration of each song.</div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div>Once processing is complete, you'll receive your tracks in high-quality MP3 format.</div>
        </div>

        <div className="text-sm text-muted-foreground">
          Note: This tool is for personal use only. Please respect copyright laws and artists' rights when downloading music.
        </div>
      </div>
